...
export default function Sidebar({ 
  ...
  return (
    <aside className={`bg-white rounded-lg p-5 sticky top-24 h-fit transition-all duration-300 ${isMobileView ? 'w-full shadow-none' : 'w-64 shadow-md hover:shadow-lg'}`}>
      ...
      {/* City Filter */}
      <div className="mb-3 p-3 rounded-lg border border-gray-100 bg-white shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        {expandedSections.city && (
          <div className="space-y-1 bg-white rounded-lg p-2 border border-gray-100 animate-in slide-in-from-top-2 duration-200">
            <button
      ...
      {/* Make Filter */}
      <div className="mb-3 p-3 rounded-lg border border-gray-200 bg-white shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        {expandedSections.make && (
          <div className="space-y-1 bg-white shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 rounded-lg p-2 border border-gray-100 animate-in slide-in-from-top-2 duration-200">
            <button
      ...
      {/* Deal Type Filter */}
      <div className="mb-3 p-3 rounded-lg border border-gray-200 bg-white shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('dealType')}>
          <div className="flex items-center gap-2">
