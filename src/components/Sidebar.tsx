...
export default function Sidebar({ 
  ...
  return (
    <aside className={`bg-white rounded-lg p-5 sticky top-24 h-fit transition-all duration-300 ${isMobileView ? 'w-full shadow-none' : 'w-64 shadow-md hover:shadow-lg'}`}>
      ...
      {/* City Filter */}
      <div className="mb-3 p-3 rounded-lg border border-gray-200 bg-gray-50/50">
      ...
      <div className="mb-3 p-3 rounded-lg border border-gray-200 bg-gray-50/50">
        ...
        {expandedSections.model && (
          <div className="space-y-1 max-h-40 overflow-y-auto bg-gray-50/50 rounded-lg p-2 border border-gray-100 animate-in slide-in-from-top-2 duration-200">
