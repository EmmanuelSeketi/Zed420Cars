...
export default function Sidebar({ 
  ...
  return (
    <aside className="bg-white rounded-lg border border-gray-200 p-5 sticky top-24 h-fit shadow-sm w-64">
      ...
      {/* City Filter */}
      <div className="mb-6">
        <div className="flex items-center justify-between cursor-pointer mb-4" onClick={() => toggleSection('city')}>
      ...
      {/* Make Filter */}
      <div className="mb-6">
        <div className="flex items-center justify-between cursor-pointer mb-4" onClick={() => toggleSection('make')}>
          <div className="flex items-center gap-2">
      ...
      {/* Model Filter */}
      <div className="mb-4">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('model')}>
          <div className="flex items-center gap-2">
        ...
        {expandedSections.model && (
          <div className="space-y-1 max-h-40 overflow-y-auto">
            <button onClick={() => onModelChange('All')} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedModel === 'All' ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
              All Models
            </button>
            {models.map(model => (
              <button key={model} onClick={() => onModelChange(model)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedModel === model ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
                {model}
              </button>
            ))}
          </div>
      ...
      {/* Body Type Filter */}
      <div className="mb-4">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('bodyType')}>
          <div className="flex items-center gap-2">
        ...
        {expandedSections.bodyType && (
          <div className="space-y-1">
            <button onClick={() => onBodyTypeChange('All')} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedBodyType === 'All' ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
              All Body Types
            </button>
            {bodyTypes.map(type => (
              <button key={type} onClick={() => onBodyTypeChange(type)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedBodyType === type ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
                {type}
              </button>
            ))}
          </div>
      ...
      {/* Mileage Filter */}
      <div className="mb-4">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('mileage')}>
          <div className="flex items-center gap-2">
        ...
        {expandedSections.mileage && (
          <div className="space-y-1">
            {mileageRanges.map(range => (
              <button key={range} onClick={() => onMileageChange(range)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedMileage === range ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
                {range === 'All' ? 'All Mileages' : range}
              </button>
            ))}
          </div>
        )}
      ...
      {/* Year Filter */}
      <div className="mb-4">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('year')}>
          <div className="flex items-center gap-2">
        ...
        {expandedSections.year && (
          <div className="space-y-1">
            <button onClick={() => onYearChange('All')} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedYear === 'All' ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
              All Years
            </button>
            {years.map(year => (
              <button key={year} onClick={() => onYearChange(year)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedYear === year ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
                {year}
              </button>
            ))}
          </div>
      ...
      {/* Transmission Filter */}
      <div className="mb-4">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('transmission')}>
          <div className="flex items-center gap-2">
        ...
        {expandedSections.transmission && (
          <div className="space-y-1">
            <button onClick={() => onTransmissionChange('All')} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedTransmission === 'All' ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
              All Transmissions
            </button>
            {transmissions.map(trans => (
              <button key={trans} onClick={() => onTransmissionChange(trans)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedTransmission === trans ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
                {trans}
              </button>
            ))}
          </div>
        ...
        {expandedSections.price && (
          <div className="space-y-1">
            {priceRanges.map(range => (
              <button key={range} onClick={() => onPriceChange(range)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedPrice === range ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
      ...
      {/* Fuel Type Filter */}
      <div className="mb-4">
        <div className="flex items-center justify-between cursor-pointer mb-3" onClick={() => toggleSection('fuelType')}>
          <div className="flex items-center gap-2">
        ...
        {expandedSections.fuelType && (
          <div className="space-y-1">
            <button onClick={() => onFuelTypeChange('All')} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedFuelType === 'All' ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
              All Fuel Types
            </button>
            {fuelTypes.map(fuel => (
              <button key={fuel} onClick={() => onFuelTypeChange(fuel)} className={`w-full text-left px-3 py-1.5 rounded-lg transition-all text-xs ${selectedFuelType === fuel ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-100'}`}>
                {fuel}
              </button>
            ))}
          </div>
