...
export default function NewListingsSection({ cars, onCarClick, wishlist, onToggleWishlist, viewMode }: NewListingsSectionProps) {
  const newListings = cars.slice(4, 8)
      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Latest Listing
            <span className="text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full text-sm">{newListings.length}</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
          {newListings.map(car => (
            ...
            >
              ...
              <div className="absolute top-3 left-3 z-10 bg-green-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-md">
                Latest
              </div>
              
              {car.dealType && (
                <div className={`absolute top-3 left-16 z-10 text-xs font-bold px-3 py-1.5 rounded-full shadow-md ${
